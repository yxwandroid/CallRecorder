...
class CallRecord private constructor(private val mContext: Context) {
    ...
    fun enableSaveFile() {
        ...
        Logger.i("CallRecord", "Save file enabled")
    }

    fun disableSaveFile() {
        Logger.i("CallRecord", "Save file disabled")
    ...
    fun changeRecordFileName(newFileName: String?) {
        ...
        Logger.i("CallRecord", "New file name: $newFileName")
    }
    ...
    fun changeRecordDirName(newDirName: String?) {
        ...
        Logger.i("CallRecord", "New dir name: $newDirName")
    }
    ...
    fun changeRecordDirPath(newDirPath: String?) {
        ...
        Logger.i("CallRecord", "New dir path: $newDirPath")
    }
